...
namespace logic {
EntityModel::EntityModel(float x, float y, float width, float height) : x(x), y(y), width(width), height(height) {}

EntityModel::~EntityModel() {}

float EntityModel::getX() const { return x; }

float EntityModel::getY() const { return y; }
